...
{
       0,   132,   132,   134,   134,   136,   136,   138,   140,   140,
     142,   142,   143,   143,   144,   145,   146,   147,   148,   151,
     153,   153,   157,   163,   156,   182,   182,   183,   183,   184,
     184,   192,   192,   194,   194,   194,   194,   194,   194,   194,
     194,   197,   197,   198,   199,   201,   201,   202,   202,   205,
     205,   205,   207,   207,   207,   208,   208,   209,   209,   209,
     209,   209,   211,   211,   213,   213,   214,   216,   223,   225,
     225,   226,   226,   227,   227,   228,   228,   229,   229,   230,
     231,   232,   235,   236,   238,   239,   241,   242,   244,   245,
     246,   247,   248,   249,   250,   252,   253,   254,   259,   260,
     261,   264,   265,   266,   269,   269,   270,   270,   271,   271,
     271,   272,   282,   282,   284,   285,   287,   296,   297,   298,
     299,   301
};
#endif
...
static const char *const yytname[] =
{
  ...
  "selectionStmt", "$@5", "else", "$@6", "iterationStmt", "$@7", "$@8",
  "$@9", "$@10", "$@11", "$@12", "$@13", "optExpression", "jumpStmt",
  "returnStmt", "breakStmt", "expression", "$@14", "$@15", "$@16", "$@17",
  "$@18", "simpleExpression", "andExpression", "unaryRelExpression",
...
#line 142 "parser.y" /* yacc.c:1646  */
    {gencode(); (yyvsp[-2].tbEntry)->value = valAssign; typeCheck((yyvsp[-2].tbEntry),(yyvsp[0].tbEntry),"="); is_declaration=1;}
...
#line 163 "parser.y" /* yacc.c:1646  */
    {
                                               fill_parameter_list((yyvsp[-4].tbEntry),param_list,p_idx);
                                                ...
                                                if(flag == 0){return -1;}
                                                p=1;
                                                gencode_function((yyvsp[-4].tbEntry)->lexeme);
                                            }
...
#line 216 "parser.y" /* yacc.c:1646  */
    {
                                      return_exists = 1;
                                      if(strcmp(curr_data_type,(yyvsp[0].tbEntry)->data_type)!=0)
...
#line 1782 "y.tab.c" /* yacc.c:1646  */
  ...
  case 70:
#line 225 "parser.y" /* yacc.c:1646  */
    {typeCheck((yyvsp[-3].tbEntry),(yyvsp[0].tbEntry),"=");(yyval.tbEntry) = (yyvsp[-3].tbEntry);gencode(); (yyvsp[-3].tbEntry)->value = valAssign;}
...
#line 230 "parser.y" /* yacc.c:1646  */
    {typeCheck((yyvsp[-1].tbEntry),(yyvsp[-1].tbEntry),"++"); (yyval.tbEntry) = (yyvsp[-1].tbEntry);}
...
#line 235 "parser.y" /* yacc.c:1646  */
    {typeCheck((yyvsp[-2].tbEntry),(yyvsp[0].tbEntry),"||"); (yyval.tbEntry) = (yyvsp[-2].tbEntry);{push("||");}gencode();}
...
#line 241 "parser.y" /* yacc.c:1646  */
    { typeCheck((yyvsp[0].tbEntry),(yyvsp[0].tbEntry),"!u");(yyval.tbEntry) = (yyvsp[0].tbEntry);{push("!");} }
...
#line 248 "parser.y" /* yacc.c:1646  */
    {typeCheck((yyvsp[-2].tbEntry),(yyvsp[0].tbEntry),"!=");{push("!=");} gencode();}
...
#line 264 "parser.y" /* yacc.c:1646  */
    { typeCheck((yyvsp[0].tbEntry),(yyvsp[0].tbEntry),"+u");(yyval.tbEntry) = (yyvsp[0].tbEntry); {push("+");}gencode_unary();}
...
#line 270 "parser.y" /* yacc.c:1646  */
    {if(checkScope(yylval.str) == 0){ return -1;}; (yyval.tbEntry) = (yyvsp[0].tbEntry);}
...
#line 272 "parser.y" /* yacc.c:1646  */
    { 
                                      ...
                                      {fprintf(output,"call %s,%d\n",(yyvsp[-3].tbEntry)->lexeme,(yyvsp[-3].tbEntry)->num_params);}
                                      is_call = 1;
                                    }
...
#line 287 "parser.y" /* yacc.c:1646  */
    {
                            arg_list[a_idx] = (char *)malloc(sizeof((yyvsp[0].tbEntry)));
                            strcpy(arg_list[a_idx++],(yyvsp[0].tbEntry)->data_type);
...
#line 296 "parser.y" /* yacc.c:1646  */
    { (yyval.tbEntry) = (yyvsp[0].tbEntry);push((yyvsp[0].tbEntry)->lexeme);}
